...
<div id="content">
	...
	<ul id="nav_dot">
			...
			<li>
	          ...
	          <div class="list-item none">
	            <a href='${ctx}/admin/yy/frame.html?flag=1' target="page">客户列表</a>
	          </div>
	        </li>
	        <li>
	        ...
	        <li>
	          ...
	          <div class="list-item none">
	            <a href='${ctx}/admin/all/frame.html?flag=1' target="page">客户流向查询</a>
...
<div id="footer"><p>医药销售管理系统</p></div>
