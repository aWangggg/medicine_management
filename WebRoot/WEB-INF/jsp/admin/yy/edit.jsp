...
<td class="outDetail2">
<select id="yyType" name="yyType">
								<option value="三级" ${map.yyType=='三级'?'selected':'' }>三级</option>
								<option value="二级" ${map.yyType=='二级'?'selected':'' }>二级</option>
								<option value="一级" ${map.yyType=='一级'?'selected':'' }>一级</option>
								<option value="个人" ${map.yyType=='个人'?'selected':'' }>个人</option>
								<option value="企业" ${map.yyType=='企业'?'selected':'' }>企业</option>
					</select>
</td>
</tr>
		<c:if test="${1==1 }"></c:if>
