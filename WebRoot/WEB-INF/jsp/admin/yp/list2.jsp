...
<html>
	<body>
		<display:table name="list"
			requestURI="list2.html" class="list"
			...
			<display:column title="更新库存" style="width:40px;">
				<img src="${ctx}/resource/admin/images/pencil.png"
					onclick="return modifyOne2('${row.id}');" style="cursor:hand;"/>
			</display:column>
		<c:if test="${1==1 }"></c:if>
		</display:table>
	</body>
	...
	function modifyOne2(id){
			MyWindow.OpenCenterWindow('edit2.html?id='+id+'&flag=${param.flag}','modify',500,600);
	}
</script>
</html>
