...
<html>
	<body>
		<display:table name="list"
			...
			<display:column title="客户" property="name3"/>
			...
			<display:column title="确定回款" style="width:40px;">
				<c:if test="${row.isHk!='1' }">
				<img src="${ctx}/resource/admin/images/pencil.png"
					onclick="return editUpdate('${row.id}');" style="cursor:hand;"/>
				</c:if>
			</display:column>
		<c:if test="${1==1 }"></c:if>
		</display:table>
