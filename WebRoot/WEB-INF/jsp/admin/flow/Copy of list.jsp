...
<html>
	<body>
		<display:table name="list"
			...
			<display:column title="销售" property="name"/>
			<display:column title="药品" property="name"/>
			<display:column title="客户" property="name"/>
			<display:column title="数量" property="sl"/>
			<display:column title="时间" property="insertDate"/>
			<display:column title="回款类型" property="hkType"/>
			<display:column title="是否回款" property="isHk"/>
						<c:choose>
